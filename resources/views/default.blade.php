...
<body class="p-0 m-0" onload="startTime()">
	...
	<div class="collapse navbar-collapse">
		<ul class="navbar-nav">
			...
			<
			<li class="nav-item dropdown" id="factures">
				<a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown5" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<span
							class="icon icon-file-text"></span>Pro Format
						</a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown5">
							<a class="dropdown-item" href="javascript:void(0)" onclick="document.location.href='{{Route('PFObjets')}}';">Pro Format objets</a>
							<a class="dropdown-item"href="javascript:void(0)" onclick="document.location.href='{{Route('PFModels')}}';">Pro Format Models</a>
